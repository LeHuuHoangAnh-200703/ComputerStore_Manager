                                        ...
                                        <div class="lg:col-span-2">
                                            <form action="" method="post"
                                                ...
                                                <div class="md:col-span-5">
                                                    <label for="idManufacturers" class="font-semibold text-[16px]">Mã nhà sản xuất</label>
                                                    <input type="text" name="idManufacturers" id="idManufacturers"
                                                        class="h-10 border mt-1 rounded px-4 w-full bg-gray-50"
                                                        placeholder="Nhập mã nhà sản xuất ..." />
                                                </div>

                                                <div class="md:col-span-5">
                                                    <label for="nameManufacturers" class="font-semibold text-[16px]">Tên nhà sản xuất</label>
                                                    <input type="text" name="nameManufacturers" id="nameManufacturers"
                                                        class="h-10 border mt-1 rounded px-4 w-full bg-gray-50"
                                                        placeholder="Nhập tên nhà sản xuất ..." />
                                                </div>

                                                <div class="md:col-span-5">
                                                    <label for="country" class="font-semibold text-[16px]">Quốc gia</label>
                                                ...
                                                <div class="md:col-span-5 text-right">
                                                    <div class="inline-flex items-end">
                                                        <button type="submit"
                                                            class="bg-[#333f48] hover:bg-blue-primary text-white font-bold py-2 px-4 rounded">Thêm nhà sản xuất</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                    ...
                    <div class="h-full bg-white rounded-xl">
                        ...
                        <div id="all_products" class="overflow-auto">
                            <table class="w-full border-collapse whitespace-nowrap text-center text-sm text-gray-500">
                                <thead class="">
                                    <tr>
                                        <th scope="col" class="px-6 py-4 font-semibold text-gray-900">Mã nhà sản xuất</th>
