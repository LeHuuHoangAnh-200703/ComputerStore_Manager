                ...
                <div class="flex flex-col md:flex-row">
                    ...
                    <div class="w-full md:w-1/2 p-8 md:p-12">
                        ...
                        <form action="" class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="password" id="password"
                                    class="w-full px-4 py-3 outline-none rounded-lg border-2 border-gray-300 focus:border-blue-secondary focus:ring-blue-secondary transition duration-150 ease-in-out"
                                    placeholder="••••••••" />
                            </div>
                            <button type="submit"
                        ...
                        <p class="mt-8 text-center text-sm text-gray-600">
                            Nếu đã có tài khoản?
                            <a href="#"
                                class="font-medium text-blue-primary hover:text-blue-secondary transition duration-150 ease-in-out">Đăng
                                nhập</a>
                        </p>
                    </div>
                </div>
